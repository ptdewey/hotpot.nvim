...
do
  local case_14_ = vim.loop.fs_access(lua_path, "R")
...
do
  local case_18_ = ((stats_a.mtime.sec == stats_b.mtime.sec) and (stats_a.mtime.nsec == stats_b.mtime.nsec))
